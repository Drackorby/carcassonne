...
class PointsCollector:
    ...
    @classmethod
    def remove_meeples_and_collect_points(cls, game_state: CarcassonneGameState, coordinate: Coordinate,remove_meeples = True):
    ...
    @classmethod
    def count_score(cls, game_state: CarcassonneGameState):
